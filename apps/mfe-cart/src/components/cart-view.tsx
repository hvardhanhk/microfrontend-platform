...
import { Badge, Button, Card, CardBody, CardFooter, CardHeader } from '@platform/ui';
import { formatCurrency } from '@platform/utils';

/**
 * CartView — reads from the Zustand cart store which is persisted to
 * localStorage.  When the user adds an item in the products zone and then
 * navigates here (full-page navigation), Zustand re-hydrates from localStorage
 * on mount so the cart is always up to date without any server round-trip.
 */
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardBody className="flex flex-col items-center py-16">
            ...
            {/* Cross-zone navigation — plain <a> triggers a full-page load into
                the products zone */}
