...
export function CartView() {
  useEventBus('product:add-to-cart', (payload) => {
    console.log('[Cart MFE] Product added:', payload.productId);
  }, { replayLast: true });

  const items = [
    { id: '1', name: 'Wireless Headphones', price: 79.99, qty: 2, img: 'https://picsum.photos/seed/10/100' },
    { id: '2', name: 'Laptop Stand', price: 49.99, qty: 1, img: 'https://picsum.photos/seed/11/100' },
  ];
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3">
      ...
      <Card className="h-fit">
        <CardHeader><h2 className="text-lg font-semibold">Summary</h2></CardHeader>
        ...
        <CardFooter><Button className="w-full" size="lg">Checkout</Button></CardFooter>
      </Card>
    </div>
  );
}
